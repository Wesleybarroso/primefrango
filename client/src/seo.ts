...
export function metadataForPath(pathname: string): PageMetadata {
  ...
  if (path === "/minha-conta") return { title: "Minha conta | Prime Frango Assado", description: "Consulte seus pedidos, acompanhe entregas e gerencie sua conta na Prime Frango Assado.", canonicalPath: "/minha-conta", noindex: true };
